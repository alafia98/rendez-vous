       ...
       <div class="container-fluid page-body-wrapper content-wrapper">
            <div class="container">
				...
				<section class="content">
					<!-- Default box -->
					<form action="{{url('update_calendrier', $calendrier->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input value="{{$calendrier->date}}" type="date" name="date" id="date" class="form-control" style="color: black">	
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="heure_debut">Heure Début</label>
                                                <input value="{{$calendrier->heure_debut}}" type="time" name="heure_debut" id="heure_debut" class="form-control" style="color: black">	
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input  value="{{$calendrier->heure_debut}}" type="time" name="heure_fin" id="heure_fin" class="form-control" style="color: black">	
                                            </div>
                                        </div>	
                                    </div> 
                                </div>							
