       ...
       <div class="container-fluid page-body-wrapper content-wrapper">
            <div class="container">
					...
					<div class="container-fluid my-2">
						<div class="row mb-2">
							<div class="col-sm-6" style="margin: 20px 0;">
								<h1 style="font-size: 1.7rem;">Modifier un Lieu</h1>
							</div>
						</div>
					</div>
					<!-- /.container-fluid -->
				...
				<section class="content">
					<!-- Default box -->
					<form action="{{url('update_lieu', $lieu->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input value="{{$lieu->nom_fr}}" type="text" name="nom_fr" id="nom_fr" class="form-control" style="color: black">	
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
