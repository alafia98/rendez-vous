       ...
       <div class="container-fluid page-body-wrapper content-wrapper">
            <div class="container">
				...
				<section class="content">
					<!-- Default box -->
					<form action="{{url('update_time', $time->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input value="{{$time->time}}" type="time" name="time" id="time" class="form-control" style="color: black">	
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label>Filière :</label>
